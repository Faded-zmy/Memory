...
def main():
    ...
    # print(combinations)
    folders = ['/ai_jfs/lifeng/data/character/characters_dialogue/characters_dialogue_20230608_gpu2',
'/ai_jfs/lifeng/data/character/characters_dialogue/characters_dialogue_20230613_gpu2',
'/ai_jfs/lifeng/data/character/characters_dialogue/characters_dialogue_20230616_gpu2']

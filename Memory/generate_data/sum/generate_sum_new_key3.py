...
def generate_instruction_following_data(
    ...
    if not os.path.exists('/ai_jfs/mengying/data/sum/log/log3/' + date):
        os.mkdir('/ai_jfs/mengying/data/sum/log/log3/' + date)
    file_handler = logging.FileHandler('/ai_jfs/mengying/data/sum/log/log3/' + date + '/generate_characters_' + str(split_id) + '.log', encoding='utf-8')
...
def main():
    ...
    # print(combinations)
    folders = ['/ai_jfs/lifeng/data/character/characters_dialogue/characters_dialogue_20230616_gpu1',
               '/ai_jfs/lifeng/data/character/characters_dialogue/characters_dialogue_20230621_gpu2']

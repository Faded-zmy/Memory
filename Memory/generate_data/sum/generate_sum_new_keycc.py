...
def generate_instruction_following_data(
    ...
    if not os.path.exists('/ai_jfs/mengying/data/sum/log/log_cc/' + date):
        os.mkdir('/ai_jfs/mengying/data/sum/log/log_cc/' + date)
    file_handler = logging.FileHandler('/ai_jfs/mengying/data/sum/log/log_cc/' + date + '/generate_characters_' + str(split_id) + '.log', encoding='utf-8')
...
def main():
    ...
    # print(combinations)
    folders = ['/ai_jfs/lifeng/data/character/characters_dialogue/characters_dialogue_20230613_gpu1']

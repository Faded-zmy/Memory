...
def list_interface_input_elements(chat=False):
    ...
    elements = ['name1', 'name2', 'greeting', 'context']
    # if chat:
    #     elements += ['name1', 'name2', 'greeting', 'context', 'chat_prompt_size', 'chat_generation_attempts', 'stop_at_newline', 'mode', 'instruction_template', 'character_menu', 'name1_instruct', 'name2_instruct', 'context_instruct', 'turn_template', 'chat_style', 'chat-instruct_command']#zmy character_menu ,delta_weight_path

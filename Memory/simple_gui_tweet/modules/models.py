...
#     tokenizer = AutoTokenizer.from_pretrained(f'{shared.args.tweet_model}/', use_fast=False)
#     base_model = AutoModelForCausalLM.from_pretrained(
#         f"{shared.args.tweet_model}/", torch_dtype=torch.float16
#     )
#     return base_model,tokenizer

def load_base_model(model_name):
    print("ZMY-model-dir",shared.args.model_dir)
    tokenizer = AutoTokenizer.from_pretrained(f"{shared.args.model_dir}/", use_fast=False)
    base_model = AutoModelForCausalLM.from_pretrained(
        f"{shared.args.model_dir}/", torch_dtype=torch.float16
    )
    return base_model,tokenizer
